...
trait Unliftables extends QuatUnliftable {
  ...
  implicit val liftUnliftable: Unliftable[Lift] = Unliftable[Lift] {
    case q"$pack.ScalarValueLift.apply(${ a: String }, $b, $c, ${ u: String }, ${ quat: Quat })" => ScalarValueLift(a, b, c, u, quat)
    case q"$pack.CaseClassValueLift.apply(${ a: String }, $b, ${ quat: Quat })"                  => CaseClassValueLift(a, b, quat)
    case q"$pack.ScalarQueryLift.apply(${ a: String }, $b, $c, ${ u: String }, ${ quat: Quat })" => ScalarQueryLift(a, b, c, u, quat)
